                ...
                <div className="resum">
                    <div className="resum-left">
                         ...
                         <div   className="work">
                            ...
                            <div className="one">
                                <p className="tnt"><FiChevronRight/> Precisely translating complex app designs into
meticulously crafted frontend code.</p>
                            </div>
                            <div className="one">
                                <p className="tnt"><FiChevronRight/> Collaborating closely with backend developers to ensure
seamless integration of UI components with APIs and
databases, adhering to RESTful API principles.</p>
                            </div>
                            <div className="one">
                                <p className="tnt"><FiChevronRight/> Writing maintainable and performance-optimized code
by leveraging modern frontend technologies and
patterns.</p>
                            </div>
                            <div className="one">
                                <p className="tnt"><FiChevronRight/> Extensively using version control systems like Git to
manage codebase and facilitate collaborative
development</p>
                            </div>
                            <div className="one">
                                <p className="tnt"><FiChevronRight/> Conducting thorough testing and debugging to maintain
