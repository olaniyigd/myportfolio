        ...
        <div id="resume">
            ...
            <div className="resum">
                <div className="resum-left">
                    ...
                    <div className="work">
                        <h3 className="lio">Frontend Engineer</h3>
                        <h4 className="mio">WildFire B.S Ltd <span className="you">Contract</span></h4>
                        <h5>Lagos, Lagos State, Nigeria.</h5>
                        <h5>June 2024 - August 2024.</h5>
                        <div className="one">
                            <p className="tnt"><FiChevronRight /> Translating intricate UI/UX designs into responsive and pixel-perfect frontend code, ensuring a consistent user experience across devices.</p>
                        </div>
                        <div className="one">
                            <p className="tnt"><FiChevronRight /> Working closely with backend teams to ensure smooth integration of frontend components with RESTful APIs, focusing on data accuracy and seamless user interaction.</p>
                        </div>
                        <div className="one">
                            <p className="tnt"><FiChevronRight />Performing rigorous testing, including unit and integration tests, to identify and fix bugs, ensuring a reliable and user-friendly interface.</p>
                        </div>
                    </div>
                    <div className="work">
                        <h3 className="lio">Frontend Engineer</h3>
                        <h4 className="mio">Thrillers Travels <span className="you">Full-Time Remote</span></h4>
                        <h5>Lagos, Lagos State, Nigeria.</h5>
                        <h5>April 2024 - May 2024.</h5>
                        <div className="one">
                    ...
                    <div className="work">
                        <h3 className="lio">Frontend Engineer</h3>
                        <h4 className="mio">MSME Ecosystem Ltd <span className="you">Full-Time Onsite</span></h4>
                        <h5>No 8B, Stadium Road, Unity, Ilorin, Kwara State, Nigeria.</h5>
